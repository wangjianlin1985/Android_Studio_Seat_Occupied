...
public class MoreActivity extends Activity {
	private String[] strs = new String[]{"座位管理","座位预约管理","选座管理","举报管理","奖惩管理","关于"};
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if(declare.getIdentify().equals("user"))
			strs = new String[]{"我的举报管理","我的奖惩管理","修改个人信息","关于"};
		...
		list.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(declare.getIdentify().equals("admin")) {
					...
					if(arg2 == 0){
						Intent intent  = new Intent(MoreActivity.this, JubaoUserListActivity.class);
						startActivity(intent);
					}
					if(arg2 == 1){
						Intent intent  = new Intent(MoreActivity.this, JcUserListActivity.class);
						startActivity(intent);
					}

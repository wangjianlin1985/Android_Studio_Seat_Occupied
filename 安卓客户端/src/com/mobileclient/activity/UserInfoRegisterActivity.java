			...
			public void onClick(View v) {
				try {
					...
					if(ET_blackFlag.getText().toString().equals("")) {
						Toast.makeText(UserInfoRegisterActivity.this, "是否黑名单输入不能为空!", Toast.LENGTH_LONG).show();
					...
					if(ET_creditScore.getText().toString().equals("")) {
						Toast.makeText(UserInfoRegisterActivity.this, "信用分输入不能为空!", Toast.LENGTH_LONG).show();
